export const languages = [
  { code: "hi", name: "हिंदी", abbr: "HI" },
  { code: "en", name: "English", abbr: "EN" },
  { code: "bn", name: "বাংলা", abbr: "BN" },
  { code: "ta", name: "தமிழ்", abbr: "TA" },
  { code: "te", name: "తెలుగు", abbr: "TE" },
  { code: "mr", name: "मराठी", abbr: "MR" },
  { code: "ur", name: "اردو", abbr: "UR" },
  { code: "pa", name: "ਪੰਜਾਬੀ", abbr: "PA" },
];
...
export const testimonials = [
  {
    ...
    quote:
      "घर घर गैस ने मेरी जिंदगी बदल दी। अब मैं बिना पैसे की चिंता के गैस रिफिल करा सकती हूं।",
    translation:
      "Ghar Ghar Gas changed my life. Now I can refill gas without worrying about money.",
  ...
  },
  {
    ...
    language: "English",
    customerType: "Commercial - Tea Stall",
    quote:
      "My tea stall business has grown 40% since joining this program. The EMI system is very helpful for small businesses like mine.",
    image: "/placeholder.svg?height=80&width=80",
    rating: 5,
  },
  {
  ...
  },
  {
    ...
    language: "Punjabi",
    customerType: "Commercial - Dhaba",
    quote:
      "ਸਾਡੇ ਢਾਬੇ ਲਈ ਇਹ ਬਹੁਤ ਵਧੀਆ ਸਕੀਮ ਹੈ। ਹੁਣ ਗੈਸ ਦੀ ਚਿੰਤਾ ਨਹੀਂ ਕਰਨੀ ਪੈਂਦੀ।",
    translation:
      "This is a great scheme for our dhaba. Now we don't have to worry about gas.",
    image: "/placeholder.svg?height=80&width=80",
    rating: 5,
  },
];