      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 mb-2">
            {t.getConnectionNowPayLater}
          </p>
          <p className="text-lg text-orange-500 font-semibold">
            अभी कनेक्शन लें, बाद में भुगतान करें
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="text-center mb-6">
              <div className="text-3xl font-bold text-[#0B1C39] mb-2">
                ₹1,500
              </div>
        ...
        <div className="mt-16">
          <h3 className="text-2xl font-bold text-center text-[#0B1C39] mb-8">
            {t.perfectForCommercial}
          </h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto">
            {businessTypes.map((business, index) => (
              ...
              >
                ...
                <h4 className="font-semibold text-[#0B1C39] text-sm">
                  {business.name}
                </h4>
