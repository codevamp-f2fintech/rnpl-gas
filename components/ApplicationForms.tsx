      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-[#0B1C39] mb-4">
            {t.applyConnectionRefill}
          </h2>
          <p className="text-xl text-gray-600">
            कनेक्शन/रिफिल के लिए आवेदन करें
          </p>
        </div>
            ...
            {activeApplicationTab === "domestic" && (
              ...
              >
                <h3 className="text-2xl font-bold text-[#0B1C39] mb-6 text-center">
                  {t.domesticConnectionRefillApp}
                </h3>
                <form
                  className="grid md:grid-cols-2 gap-6"
                  role="form"
                  aria-label="Domestic application form"
                >
                  <div>
                    <label
                      htmlFor="domestic-name"
            ...
            {activeApplicationTab === "commercial" && (
              ...
              >
                ...
                <form
                  className="grid md:grid-cols-2 gap-6"
                  role="form"
                  aria-label="Commercial application form"
                >
                  <div>
                    <label
                      htmlFor="commercial-business-name"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                  ...
                  <div>
                    <label
                      htmlFor="commercial-business-type"
                      className="block text-sm font-medium text-gray-700 mb-2"
                    >
                    ...
                    >
                      ...
                      <option value="tea-stall">
                        Tea Stall / चाय की दुकान
                      </option>
                      <option value="food-vendor">
                        Food Vendor / खाना विक्रेता
                      </option>
